...
using FridayFun.Models;
using FridayFun.Data;
using FridayFun.Filter;
using FridayFun.Entities;
using FridayFun.Authorization;
using Microsoft.AspNetCore.Authorization;

namespace FridayFun.Controllers
{
    /// <summary>
    ...
    {
        private readonly FridayFunContext _context;

        public RoleEntitlementController(FridayFunContext context)
        {
            _context = context;
        }
